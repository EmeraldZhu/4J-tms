<template>
                ...
                <Stepper orientation="vertical">
                        ...
                        <StepperPanel header="Personal Info">
                                <template #content="{ nextCallback }">
                                        <div class="flex flex-column gap-2 mx-auto"
                                                ...
                                                <div class="text-center mt-3 mb-3 text-xl font-semibold">Personal Info
                                                </div>
                                                <div class="field p-fluid">
                                                        <FloatLabel>
                                                                <InputText type="text" id="fullNames"
                                                                        v-model="tenant.fullNames" required />
                                                                <label for="fullNames">Full names*</label>
                                                        </FloatLabel>
                                                        <br>
                                                        <FloatLabel>
                                                                <InputText type="email" id="email"
                                                                        v-model="tenant.email" required />
                                                                <label for="email">Email*</label>
                                                        </FloatLabel>
                                                        <br>
                                                        <FloatLabel>
                                                                <Calendar id="dob" v-model="tenant.dob"
                                                                        dateFormat="dd/mm/yy"></Calendar>
                                                                <label for="dob">Date of Birth</label>
                                                        </FloatLabel>
                                                        <br>
                                                        <FloatLabel>
                                                                <InputText type="text" id="idNumber"
                                                                        v-model="tenant.idNumber" />
                                                                <label for="idNumber">National ID Number</label>
                                                        </FloatLabel>
                                                        <br>
                                                        <FloatLabel>
                                                                <Dropdown id="gender" v-model="tenant.gender"
                                                                        :options="genders" optionLabel="name"
                                                                        placeholder="Select Gender" required></Dropdown>
                        ...
                        <StepperPanel header="Check-in Status">
                                <template #content="{ prevCallback, nextCallback }">
                                        <div class="flex flex-column gap-2 mx-auto"
                                                style="min-height: 16rem; max-width: 20rem">
                                                <div class="text-center mt-3 mb-3 text-xl font-semibold">Check-in Status
                                                </div>
                                                <div class="field p-fluid">
                                                        <FloatLabel>
                                                                <Dropdown id="checkInStatus"
                                                                        v-model="tenant.checkInStatus"
                                                                        :options="checkInStatuses" optionLabel="name"
                                                                        placeholder="Checked In?" required></Dropdown>
                                                                <label for="checkInStatus">Checked In?</label>
                                                        </FloatLabel>
                                                        <br>
                                                        <FloatLabel
                                                                v-if="tenant.checkInStatus && tenant.checkInStatus.value === 'yes'">
                                                                <Calendar id="checkInDate" v-model="tenant.checkInDate"
                                                                        dateFormat="dd/mm/yy"></Calendar>
                                                        ...
                                                        <FloatLabel
                                                                v-if="tenant.checkInStatus && tenant.checkInStatus.value === 'yes'">
                                                                <Calendar id="checkOutDate"
                                                                        v-model="tenant.checkOutDate"
                                                                        dateFormat="dd/mm/yy"></Calendar>
                        ...
                        <StepperPanel header="Property & Unit Assignment">
                                <template #content="{ prevCallback }">
                                        <div class="flex flex-column gap-2 mx-auto"
                                                style="min-height: 16rem; max-width: 20rem">
                                                <div class="text-center mt-3 mb-3 text-xl font-semibold">Property & Unit
                                                        Assignment</div>
                                                <div class="field p-fluid">
                                                        <div class="text-start mt-3 mb-3">Property Name</div>
                                                        <Dropdown v-model="propertyName" editable
                                                                :options="propertyNames" optionLabel="label"
                                                                placeholder="Choose property" />
                                                        <div class="text-start mt-3 mb-3">Unit Name</div>
                                                        <Dropdown v-model="propertyUnitName" editable
                                                                :options="unitNames" optionLabel="label"
                                                                placeholder="Choose unit name" />
                                                </div>
                                        </div>
                                        <div class="flex pt-4 justify-content-between">
                                                <Button label="Back" severity="secondary" icon="pi pi-arrow-left"
                                                        @click="prevCallback" />
                                                <Button label="Add Tenant" icon="pi pi-plus-circle" @click="addTenant"
        ...
        <div class="tenants-datatable">
                <DataTable v-model:filters="filters" :value="tenants" paginator :rows="10" ref="tenantsTable"
                        ...
                        <Column field="checkInDate" header="Check-in">
                                <template #body="slotProps">
                                        {{ slotProps.data.checkInDate ? new
                                        Date(slotProps.data.checkInDate).toLocaleDateString() : '' }}
                                </template>
                        </Column>
                        <Column field="checkOutDate" header="Check-out">
                                <template #body="slotProps">
                                        {{ slotProps.data.checkOutDate ? new
                                        Date(slotProps.data.checkOutDate).toLocaleDateString() : '' }}
                                </template>
                        </Column>
                        ...
                        <Column header="Action">
                                <template #body="slotProps">
                                        <Button icon="pi pi-pencil" class="p-button-rounded p-button-success mr-2"
                                                @click="editTenant($event, slotProps.data)" />
        ...
        <OverlayPanel ref="overlayPanel">
                <div class="form">
                        ...
                        <!-- Gender -->
                        <FloatLabel>
                                <Dropdown id="editGender" v-model="editingTenant.gender" :options="genders"
                                        optionLabel="name" placeholder="Select Gender" required></Dropdown>
                        ...
                        <!-- Check-in Status -->
                        <FloatLabel>
                                <Dropdown id="editCheckInStatus" v-model="editingTenant.checkInStatus"
                                        :options="checkInStatuses" optionLabel="name" placeholder="Checked In?"
                                        required>
                                </Dropdown>
                        ...
                        <FloatLabel v-if="editingTenant.checkInStatus && editingTenant.checkInStatus.value === 'yes'">
                                <Calendar id="editCheckInDate" v-model="editingTenant.checkInDate"
                                        dateFormat="dd/mm/yy">
                                </Calendar>
                        ...
                        <!-- Check-out Date -->
                        <FloatLabel v-if="editingTenant.checkInStatus && editingTenant.checkInStatus.value === 'yes'">
                                <Calendar id="editCheckOutDate" v-model="editingTenant.checkOutDate"
                                        dateFormat="dd/mm/yy">
                                </Calendar>
...
const tenantsTable = ref(null);

const exportTenantsData = () => {
  tenantsTable.value.exportCSV();
}
</script>
